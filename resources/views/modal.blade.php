...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="{{ asset('stislaa/assets_node/prismjs/themes/prism.css') }}">

  <!-- Template CSS -->
  <link rel="stylesheet" href="{{ asset('stislaa/assets/css/style.css') }}">
  <link rel="stylesheet" href="{{ asset('stislaa/assets/css/components.css') }}">
</head>
...
<body>
  ...
  <script src="{{ asset('stislaa/assets/js/stisla.js') }}"></script>

  <!-- JS Libraies -->
  <script src="{{ asset('stislaa/assets_node/prismjs/prism.js') }}"></script>

  <!-- Template JS File -->
  <script src="{{ asset('stislaa/assets/js/scripts.js') }}"></script>
  <script src="{{ asset('stislaa/assets/js/custom.js') }}"></script>

  <!-- Page Specific JS File -->
  <script src="{{ asset('stislaa/assets/js/page/bootstrap-modal.js') }}"></script>
</body>
</html>
